...
st.markdown("""
    <style>
    /* MOBİL UYUMLU TEK SATIR YATAY KAYDIRILABİLİR ŞERİT (SWIPE RIBBON) TASARIMI */
    ...
    for day_idx, day in enumerate(days):
        ...
        with st.expander(expand_label, expanded=False):
            ...
            for i in range(int(num_rows)):
                ...
                # --- SAATLER İÇİN ÖZEL YATAY KAYDIRILABİLİR HTML ŞERİT BİLEŞENLERİ ---
                def render_swipeable_ribbon(label, options, current_val, key_prefix):
                    st.caption(label)
                ...
                s_choice = render_swipeable_ribbon("Başlangıç", start_slots, st.session_state[s_key], f"s_{day}_{i}_{week_no}")
                ...
                p_choice = render_swipeable_ribbon("Mola", pause_slots, st.session_state[p_key], f"p_{day}_{i}_{week_no}")
                ...
                e_choice = render_swipeable_ribbon("Bitiş", end_slots, st.session_state[e_key], f"e_{day}_{i}_{week_no}")
