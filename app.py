...
with tab_entry:
    ...
    def create_pdf(project_name, entries, expenses, week, year):
        ...
        header_text = f"<b><font size=10 color='#0F172A'>{st.session_state.comp_name}</font></b><br/><font size=7 color='#475569'>{st.session_state.comp_address}<br/>E-mail: admtechnics2018@gmail.com | GSM: 0467752557<br/>BTW: {st.session_state.comp_btw}</font>"
        ...
        # --- FİŞ GÖRSELLERİ (Her sayfaya 4 adet, 2x2 Grid Düzeni - Tamamen Hollandaca/İngilizce) ---
