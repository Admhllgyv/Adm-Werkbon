...
with tab_entry:
    ...
    # Çalışan değiştiğinde otomatik saatleri güncelleyen fonksiyon
    ...
    for day_idx, day in enumerate(days):
        ...
        with st.expander(expand_label, expanded=False):
            ...
            for i in range(int(num_rows)):
                ...
                # Session state başlangıç değerleri (Boş başlar)
    ...
    def create_pdf(project_name, entries, expenses, week, year):
        ...
        # Çalışanların ayrı ayrı çalışma saatlerini özet metnine ekliyoruz
