            ...
            for p_i in range(int(num_projects)):
                ...
                if proj_sel != "Seçiniz":
                    ...
                    for w_i in range(int(num_workers)):
                        ...
                        # Veritabanından gelen kilit ve saat bilgilerini kurtar (Sayfa yenilense bile kaybolmaz)
                        ...
                        if wrk != "Seçiniz":
                            ...
                            all_entries.append({
                                ...
                                "Bitiş": final_stop,
                                "Saat": calc_hours,
                                "Locked": is_locked  # Kilit durumu artık veritabanında kalıcı!
                            })
                        else:
