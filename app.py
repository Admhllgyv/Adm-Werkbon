...
/* Yatay Şerit ve Native CSS Scroll Snap (Otomatik Ortalama) */
...
<script>
// Tarayıcının yerleşik scrollIntoView API'si ile seçili çipi kusursuz biçimde ortala
...
// Streamlit'in sayfa yenileme (rerun) ve eleman oluşturma döngülerini yakala
[50, 150, 300, 600, 1000, 1500].forEach(delay => {
    setTimeout(centerActiveChips, delay);
});

// Herhangi bir seçim/değişiklik anında anında ortala
