...
# --- SLİDER + MANUEL GİRİŞLİ SAAT SEÇİCİ ---
def slider_with_manual_time_picker(label, session_key, default_val="08:00", min_h=3, max_h=12, step_mins=15, disabled=False):
    ...
    # Net okunaklı başlık ve anlık seçilen saat gösterimi
    st.markdown(f"<div style='font-size:12px; font-weight:bold; color:#1F4E78; margin-bottom:2px;'>{label} ➔ <span style='color:#2563EB; font-size:13px;'>{current_str}</span></div>", unsafe_allow_html=True)
                    ...
                    if proj_sel != "Seçiniz":
                        ...
                        for w_i in range(int(num_workers)):
                            ...
                            if wrk != "Seçiniz":
                                ...
                                # --- 1) BAŞLANGIÇ: 3:00 - 12:00 (15 dk adımlı) ---
                                ...
                                # --- 3) BİTİŞ: 11:00 - 20:00 (15 dk adımlı) ---
