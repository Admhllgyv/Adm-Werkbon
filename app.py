...
/* Yatay Radio Butonlarını Kompakt Çiplere Dönüştürme (Az Yer Kaplaması İçin) */
...
# --- KOMPAKT ÇİP / HAP FORMATINDA SAAT SEÇİCİ ---
                    ...
                    if proj_sel != "Seçiniz":
                        ...
                        for w_i in range(int(num_workers)):
                            ...
                            if wrk != "Seçiniz":
                                ...
                                # Kompakt Yatay Çip / Hap Formatında Saat Seçiciler
