...
with tab_entry:
    ...
    # Proje seçenekleri: Hem ismi hem numarası birlikte görünecek şekilde (Örn: Kruidvat Diepenbeek (PRJ-2026-01))
    project_options = [f"{p['name']} ({p['code']})" for p in st.session_state.projects]
    if not project_options:
        project_options = ["Genel Proje (PRJ-00)"]
