...
<script>
// Seçili olan çipi her zaman yatay şeridin tam ortasına kilitleyen gelişmiş fonksiyon
...
// Streamlit yüklenme döngüsünü yakalamak için farklı zamanlarda tetikle
[100, 300, 600, 1000, 1500].forEach(delay => {
    setTimeout(centerActiveChips, delay);
});

// Kullanıcı manuel veya otomatik seçim yaptığında anında ortala
document.addEventListener('change', (e) => {
    if (e.target && e.target.type === 'radio') {
        setTimeout(centerActiveChips, 150);
    }
});
</script>
