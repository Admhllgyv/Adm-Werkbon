...
<script>
// Seçilen çipin (saat/mola) her zaman kendi şeridinin tam ortasına gelmesini sağlayan fonksiyon
    ...
    radioContainers.forEach(container => {
        ...
        if (checkedInput) {
            ...
            if (label) {
                ...
                container.scrollTo({
                    left: labelLeft - (containerWidth / 2) + (labelWidth / 2),
                    behavior: 'smooth'
                });
            }
        }
...
setTimeout(centerActiveChips, 250);
setTimeout(centerActiveChips, 700);
</script>
