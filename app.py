...
with tab_settings:
    ...
    st.markdown("Verileriniz veritabanında otomatik saklanır, dilerseniz ek güvenlik için telefonunuza yedek indirebilirsiniz.")
    ...
    if uploaded_backup is not None:
        try:
            ...
            st.success("Tüm veriler başarıyla geri yüklendi ve veritabanına kaydedildi!")
...
with tab_entry:
    ...
    # Her veri değişiminde veritabanına kaydet
    db_save("weekly_data", st.session_state.weekly_data)
