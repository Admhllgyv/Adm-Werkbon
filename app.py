...
# Sekmeler (Önizleme / Özet sekmesi tekrar eklendi)
...
with tab_preview:
    ...
    with col_pwk:
        prev_week_no = st.selectbox("Özet Hafta No", list(range(1, 54)), index=33, key="prev_week")
...
with tab_entry:
    ...
    for day_idx, day in enumerate(days):
        ...
        with st.expander(expand_label, expanded=False):
            # Her gün için ana bir proje seçimi
