...
with tab_settings:
    ...
    st.markdown("Verilerinin (geçmiş haftalar, projeler ve ayarlar) kaybolmaması için telefonuna yedek alabilir veya eski yedeğini geri yükleyebilirsin.")
    ...
    if uploaded_backup is not None:
        try:
            ...
            st.success("Tüm veriler başarıyla geri yüklendi! Sayfayı yenileyebilirsiniz.")
