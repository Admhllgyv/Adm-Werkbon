...
/* Radyo butonlarını tek satır ve yatay kaydırılabilir (scrollable) çiplere dönüştürme */
...
# --- YATAY KAYDIRILABILIR TEK SATIR ÇİP SEÇİCİ ---
                    ...
                    if proj_sel != "Seçiniz":
                        ...
                        for w_i in range(int(num_workers)):
                            ...
                            if wrk != "Seçiniz":
                                ...
                                # Yatay kaydırılabilir tek satırlık çip formatı
                                final_start = time_picker_component("Başlangıç (03:00 - 12:00)", 3, 12, f"s_{day}{p_i}{w_i}_{week_no}", st.session_state.get(s_key, def_s), disabled=is_week_locked)
                                ...
                                final_stop = time_picker_component("Bitiş (11:00 - 20:00)", 11, 20, f"e_{day}{p_i}{w_i}_{week_no}", st.session_state.get(e_key, def_e), disabled=is_week_locked)
