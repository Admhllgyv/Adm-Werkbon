...
# Sekmeler (Önizleme sekmesi kaldırıldı, her şey temizlendi)
...
with tab_entry:
    ...
    for day_idx, day in enumerate(days):
        ...
        with st.expander(expand_label, expanded=False):
            # Varsayılan satır sayısını 0 yaptık ki çalışılmayan günlerde boş/yanlış kayıt oluşmasın
    ...
    def create_pdf(project_name, entries, expenses, week, year):
        ...
        if proj_expenses:
            ...
            for ex in proj_expenses:
                ...
                # DÜZELTME: ex['Tarih'] doğru ilişkilendirildi
    ...
    if all_entries:
        ...
        st.info("Bu hafta için henüz çalışma kaydı girilmedi. Kayıt girdiğinizde en altta PDF oluşturma butonu aktifleşecektir.")
