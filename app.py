...
<script>
// Seçili olan çipi kesin olarak yatay şeridin ortasına getiren kusursuz hesaplama fonksiyonu
    ...
    radioContainers.forEach(container => {
        ...
        if (checkedInput) {
            ...
            if (label) {
                ...
                const targetScrollLeft = container.scrollLeft + (labelRect.left + labelRect.width / 2) - (containerRect.left + containerRect.width / 2);
                container.scrollTo({
...
setTimeout(centerActiveChips, 200);
setTimeout(centerActiveChips, 600);
setTimeout(centerActiveChips, 1200);
</script>
