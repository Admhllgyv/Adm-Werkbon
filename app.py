...
st.markdown("""
    <style>
    /* Mobilde açılır kutularda (selectbox) arama çubuğunun klavye açmasını önleyen gizleme kuralı */
    div[data-baseweb="popover"] input[type="text"],
    div[data-baseweb="menu"] input[type="text"] {
...
# Eskisi gibi zengin ve çok seçenekli saat slotları
