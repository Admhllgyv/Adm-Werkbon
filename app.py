...
# --- 2/3 EKRAN SLIDER SAAT SEÇİCİ (KLAVYE AÇMAZ, SAĞDA GÜVENLİ KAYDIRMA ALANI VAR) ---
def time_picker_slider_component(label, min_h, max_h, session_key, default_val, disabled=False):
    ...
    # Ekranın 2/3'ü slider, 1/3'ü sağ tarafta boşluk (güvenli kaydırma alanı)
    ...
    with col2:
        st.markdown(f"<div style='padding-top: 6px; font-size: 12px; font-weight: bold; color: #2563EB;'>Seçilen: {selected_time}</div>", unsafe_allow_html=True)
